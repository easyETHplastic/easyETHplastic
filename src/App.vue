  ...
  <div class="bg-zinc-700 text-zinc-200">
    ...
    <div class="flex items-center mx-auto max-w-screen-xl pt-16">
      <div class="w-1/3 m-10">
        <div
          class="relative rounded-md text-xl h-48 p-6 bg-gradient-to-tr from-cyan-500 to-blue-500 hover:shadow-xl font-roboto"
        >
          <p class="text-5xl font-dmsans pt-3 pb-6">$25</p>
          <p>0123 0432 1043 3405</p>
          <p class="text-sm">01/26</p>
          <svg class="w-24 absolute bottom-0 right-0"
   version="1.1"
   id="Layer_1"
   x="0px"
   y="0px"
...
<path
   ...
   id="path835" />
      ...
      <div class="w-1/3 m-10">
        <div
          class="rounded-md h-48 p-6 bg-gradient-to-tr from-orange-300 to-orange-600 hover:shadow-xl font-roboto"
        >adfadfadf</div>
      </div>
      <div class="w-1/3 m-10">
        <div
          class="rounded-md h-48 p-6 bg-gradient-to-tr from-zinc-700 to-zinc-900 hover:shadow-xl font-roboto"
        >adfadfadf</div>
      </div>
    </div>
  </div>
...
<style scoped>
@import url("https://fonts.googleapis.com/css2?family=DM+Sans:ital,wght@0,400;0,500;0,700;1,400;1,500;1,700&family=Roboto+Mono:wght@300;400;500&display=swap");
</style>
